...
<html lang="en">
    <head>
		...
		<script type="text/javascript" src="js/mxn.js?(googlev3)"></script> -->
        <script src="http://openlayers.org/api/OpenLayers.js"></script>
		<script type="text/javascript" src="js/mxn.js?(openlayers)"></script>
		<script type="text/javascript" src="js/timeline-2.3.0.js"></script>
